...
export const CommitSettings = observer(
      ...
      <Hidden label={"AdditionalSettings"} flag={repository.openCommitSettings}>
        <div>
          <Checkbox
            ...
            flag={repository.stageAllFilesBeforeCommit}
          />
          <Checkbox
            label="Clean after commit"
            flag={repository.cleanAfterCommit}
          />
          <LocalStorageInput
            title="Precommit command"
            storage={repository.precommitCommandStorage}
          />
        </div>
      </Hidden>
    )
